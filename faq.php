			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
                         ...
                         <ol>
                            <li>The APP and Web Platform only available within the USA.</li>
                            <li>The APP suggests for restricted residential roads, low bridge clearances and weight limits.</li>
                            <li>This web is available as an App and Web platform</li>
                         </ol>
                         </h3>
					</div>
				</div>
